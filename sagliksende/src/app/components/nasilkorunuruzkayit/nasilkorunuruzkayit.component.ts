...
@Component({
  selector: 'app-nasilkorunuzkayit',
  templateUrl: './nasilkorunuruzkayit.component.html',
  styleUrls: ['./nasilkorunuruzkayit.component.scss']
})
export class NasilkorunuruzkayitComponent implements OnInit {
  kayitlar: any;
