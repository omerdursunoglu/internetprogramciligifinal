...
@Component({
  selector: 'app-nasilkorunuruz',
  templateUrl: './nasilkorunuruz.component.html',
  styleUrls: ['./nasilkorunuruz.component.scss']
})
export class NasilkorunuruzComponent implements OnInit {
  kayitlar: any;
